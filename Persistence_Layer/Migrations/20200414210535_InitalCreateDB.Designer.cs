...
namespace Persistence_Layer.Migrations
{
    ...
    [Migration("20200414210535_InitalCreateDB")]
            ...
            modelBuilder.Entity("Persistence_Layer.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2020, 4, 14, 17, 5, 35, 50, DateTimeKind.Local).AddTicks(5650),
                            Description = "Admin",
                            IsActive = true,
                            IsVisible = true,
                            LastModifiedBy = 0,
                            LastModifiedDate = new DateTime(2020, 4, 14, 17, 5, 35, 68, DateTimeKind.Local).AddTicks(6270)
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2020, 4, 14, 17, 5, 35, 68, DateTimeKind.Local).AddTicks(9880),
                            Description = "User",
                            IsActive = true,
                            IsVisible = true,
                            LastModifiedBy = 0,
                            LastModifiedDate = new DateTime(2020, 4, 14, 17, 5, 35, 68, DateTimeKind.Local).AddTicks(9920)
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2020, 4, 14, 17, 5, 35, 68, DateTimeKind.Local).AddTicks(9990),
                            Description = "Viewer",
                            IsActive = true,
                            IsVisible = true,
                            LastModifiedBy = 0,
                            LastModifiedDate = new DateTime(2020, 4, 14, 17, 5, 35, 69, DateTimeKind.Local)
                        });
                });

...
VALUES (1, 0, '2020-04-14T17:05:35.0505650-04:00', N'Admin', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-14T17:05:35.0686270-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] ON;
INSERT INTO [Roles] ([Id], [CreatedBy], [CreatedDate], [Description], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate])
VALUES (2, 0, '2020-04-14T17:05:35.0689880-04:00', N'User', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-14T17:05:35.0689920-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] ON;
INSERT INTO [Roles] ([Id], [CreatedBy], [CreatedDate], [Description], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate])
VALUES (3, 0, '2020-04-14T17:05:35.0689990-04:00', N'Viewer', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-14T17:05:35.0690000-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] OFF;
...
VALUES (N'20200414210535_InitalCreateDB', N'3.1.2');
...
VALUES (1, N'Address 1', N'Address 2', 0, '2020-04-14T17:14:38.8328550-04:00', NULL, CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-14T17:14:38.8328570-04:00', N'Business Name', N'zz', N'zzzzz');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Address1', N'Address2', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Name', N'State', N'ZipCode') AND [object_id] = OBJECT_ID(N'[Businesses]'))
...
VALUES (1, 0, '2020-04-14T17:14:38.8332360-04:00', N'New Group', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-14T17:14:38.8332370-04:00', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Order') AND [object_id] = OBJECT_ID(N'[Groups]'))
    SET IDENTITY_INSERT [Groups] OFF;

GO

UPDATE [Roles] SET [CreatedDate] = '2020-04-14T17:14:38.8151770-04:00', [LastModifiedDate] = '2020-04-14T17:14:38.8307400-04:00'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
UPDATE [Roles] SET [CreatedDate] = '2020-04-14T17:14:38.8311400-04:00', [LastModifiedDate] = '2020-04-14T17:14:38.8311430-04:00'
WHERE [Id] = 2;
SELECT @@ROWCOUNT;
...
UPDATE [Roles] SET [CreatedDate] = '2020-04-14T17:14:38.8311510-04:00', [LastModifiedDate] = '2020-04-14T17:14:38.8311510-04:00'
WHERE [Id] = 3;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200414211439_InitalCreateDB_1', N'3.1.2');
